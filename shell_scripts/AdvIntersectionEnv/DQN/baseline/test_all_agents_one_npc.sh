...
python3 experiments.py evaluate configs/AdvIntersectionEnv/env_multi_agent_dest_background.json \
                                ...
                                --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/one_npc_background_train_baseline_20220827-123347_611434/checkpoint.tar \
...
python3 experiments.py evaluate configs/AdvIntersectionEnv/one_npc/env_multi_agent_dest_good_agent.json \
                               configs/AdvIntersectionEnv/agents/DQNAgent/baseline.json \
                               --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/one_npc/baseline/one_npc_good_agent_train_baseline_20220827-151845_617419/checkpoint-best.tar \
                               --episodes=1000 --name-from-config --no-display 

# zero_sum
python3 experiments.py evaluate configs/AdvIntersectionEnv/one_npc/env_multi_agent_dest_zero_sum.json \
                               configs/AdvIntersectionEnv/agents/DQNAgent/baseline.json \
				               --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/one_npc/baseline/one_npc_zero_sum_train_baseline_20220827-171240_620943/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display

# failmaker
python3 experiments.py evaluate configs/AdvIntersectionEnv/one_npc/env_multi_agent_dest_failmaker.json \
                               configs/AdvIntersectionEnv/agents/DQNAgent/baseline.json \
				                --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/one_npc/baseline/one_npc_failmaker_train_baseline_20220827-190825_624432/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display

# rule_break
python3 experiments.py evaluate configs/AdvIntersectionEnv/one_npc/env_multi_agent_dest_rule_break.json \
                               configs/AdvIntersectionEnv/agents/DQNAgent/baseline.json \
                                --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/one_npc/baseline/one_npc_rule_break_train_baseline_20220827-203808_627204/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display 
