...
#                                --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/background_baseline_20220820-191136_296176/checkpoint.tar \
...
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_good_agent.json \
                               configs/AdvIntersectionEnv/agents/DQNAgent/baseline.json \
                               --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/three_npc/baseline/three_npc_good_agent_train_baseline_20220827-123358_611471/checkpoint-best.tar \
                               --episodes=1000 --name-from-config --no-display 

# zero_sum
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_zero_sum.json \
                               configs/AdvIntersectionEnv/agents/DQNAgent/baseline.json \
				               --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/three_npc/baseline/three_npc_zero_sum_train_baseline_20220827-142255_615664/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display

# failmaker
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_failmaker.json \
                               configs/AdvIntersectionEnv/agents/DQNAgent/baseline.json \
				                --test --recover-from=out/MultiAgentAdvIntersectionEnv/DQNAgent/three_npc/baseline/three_npc_failmaker_train_baseline_20220827-163403_619738/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display
