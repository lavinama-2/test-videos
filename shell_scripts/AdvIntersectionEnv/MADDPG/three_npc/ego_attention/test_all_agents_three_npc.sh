...
# For Stable Ego_attentions 3 training
# cd /vol/bitbucket/tg4018/MEng/rl-ego_attentions3-zoo
...
# background
# python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_background.json \
#                                 configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/ego_attention.json \
#                                 --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/ego_attention/three_npc_background_train_ego_attention_20220827-123347_611434/checkpoint.tar \
...
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_good_agent.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/ego_attention.json \
                               --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/ego_attention/three_npc_good_agent_train_ego_attention_20220827-123408_611499/checkpoint-best.tar \
                               --episodes=1000 --name-from-config --no-display 

# zero_sum
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_zero_sum.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/ego_attention.json \
				               --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/ego_attention/three_npc_zero_sum_train_ego_attention_20220827-143139_615972/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display

# failmaker
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_failmaker.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/ego_attention.json \
				                --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/ego_attention/three_npc_failmaker_train_ego_attention_20220828-123145_658991/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display

# rule_break
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_rule_break.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/ego_attention.json \
                                --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/ego_attention/three_npc_rule_break_train_ego_attention_20220827-165301_620333/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display 
