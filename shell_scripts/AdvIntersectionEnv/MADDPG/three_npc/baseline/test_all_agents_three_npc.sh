...
#                                 configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/baseline.json \
#                                 --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/baseline/three_npc_background_train_baseline_20220827-123347_611434/checkpoint.tar \
...
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_good_agent.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/baseline.json \
                               --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/baseline/three_npc_good_agent_train_baseline_20220827-123358_611471/checkpoint-best.tar \
                               --episodes=1000 --name-from-config --no-display 

# zero_sum
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_zero_sum.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/baseline.json \
				               --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/baseline/three_npc_zero_sum_train_baseline_20220827-142255_615664/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display

# failmaker
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_failmaker.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/baseline.json \
				                --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/baseline/three_npc_failmaker_train_baseline_20220827-163403_619738/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display

# rule_break
python3 experiments.py evaluate configs/AdvIntersectionEnv/three_npc/env_multi_agent_dest_rule_break.json \
                               configs/AdvIntersectionEnv/agents/MADDPGAgent/three_npc/baseline.json \
                                --test --recover-from=out/MultiAgentAdvIntersectionEnv/MADDPGAgent/three_npc/baseline/three_npc_rule_break_train_baseline_20220827-183226_623327/checkpoint-best.tar \
                                --episodes=1000 --name-from-config --no-display 
