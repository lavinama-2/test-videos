                    ...
                    if type_agent == "baseline" or type_agent == "ego_attention":
                        ...
                        for trained_agents in os.listdir(path_to_json):
                            if trained_agents[0] != ".":
                                ...
                                for file_names in os.listdir(path_trained_agents):
                                    if os.path.isfile(os.path.join(path_trained_agents, file_names)) and 'best' in file_names:
                                        path_model = os.path.join(path_trained_agents, file_names)
